...
Here, the difference for different methods is how to calculate the coefficients :math:`\tilde{\alpha}_i`. Here, we provide an example of using random weights ( by set the ``get_weight_func()`` function ). 
