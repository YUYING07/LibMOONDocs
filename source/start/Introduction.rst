...
+=======================================================================+=============================================+=======================================+===========================+
| `EPO-based PSL <https://arxiv.org/abs/2010.04104>`_                   |Pareto set learning Solvers                  |Exact solutions                        |``EPO-based PSL``          |
+-----------------------------------------------------------------------+                                             +---------------------------------------+---------------------------|
| `Aggregation-based PSL <https://arxiv.org/abs/2010.04104>`_           |                                             |Minimal aggregation function solutions |``Agg-based PSL``          |
+-----------------------------------------------------------------------+                                             +---------------------------------------+---------------------------+
| `PMGDA-based PSL <https://arxiv.org/abs/2402.09492>`_                 |                                             | Specific solutions                    |``PMGDA-based PSL``        |
+-----------------------------------------------------------------------+                                             +---------------------------------------+---------------------------+
| `Evolutionary PSL <https://arxiv.org/html/2310.20426v3>`_             |                                             |  Mitigate local minima by ES          |``Evolutionary-based PSL`` |
+-----------------------------------------------------------------------+                                             +---------------------------------------+---------------------------+
| `LoRA PSL <https://www.arxiv.org/abs/2407.20734>`_                    |                                             | Light model structure                 |``LoRA-based psl``         |
+-----------------------------------------------------------------------+---------------------------------------------+---------------------------------------+---------------------------+
| `Tch-LCB <https://ieeexplore.ieee.org/document/7969460>`_             |MultiObjective Bayesian Optimization Solvers |                                       |``PSLMOBOSolver``          |
+-----------------------------------------------------------------------+                                             +---------------------------------------+---------------------------+
| `DirHV-EI <https://ieeexplore.ieee.org/abstract/document/10093980/>`_ |                                             |                                       |``PSLDirHVEISolver``       |
+-----------------------------------------------------------------------+                                             +---------------------------------------+---------------------------+
| `DirHV-EGO <https://ieeexplore.ieee.org/document/4358754>`_           |                                             |                                       |``DirHVEGOSolver``         |
+-----------------------------------------------------------------------+---------------------------------------------+---------------------------------------+---------------------------+
